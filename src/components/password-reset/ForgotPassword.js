    ...
    return (
        <div className="forgot-password d-flex justify-content-center mx-auto pb-5">
            <div className="col-lg-3 col-md-6 mt-sm-5 pt-md-0 px-md-0 px-4">
                ...
                <FormControl variant="outlined" className="w-100 my-2" color="warning">
                    <InputLabel className="text-white">Email Address</InputLabel>
                    <OutlinedInput label='Email Address' className="text-white" />
                </FormControl>
                <div className="d-flex justify-content-center pb-5 mt-2">
                    <button disabled="isLoading" type="submit" className={isLoading ? 'border border-fwr mb-5 fw-bold mx-auto text-white mx-2 px-5 py-3 rounded-pill w-75' : 'bg-fwr mb-5 fw-bold mx-auto text-white mx-2 px-5 py-3 rounded-pill w-75'}>
